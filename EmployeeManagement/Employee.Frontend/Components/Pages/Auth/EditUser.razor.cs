...
public partial class EditUser
{
    ...
    {
        await LoadUserAsyc();
        Console.WriteLine("=== USER JSON RECEIVED ===");
        ...
        Console.WriteLine($"City.StateId: {user?.City?.StateId}");
        Console.WriteLine($"City.State: {user?.City?.State}");
        Console.WriteLine($"City.State.Country: {user?.City?.State?.Country}");
